...
Sw3NtAccessCheck PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0052574A8h        ; Load function hash into ECX.
...
Sw3NtWorkerFactoryWorkerReady PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 021A72B3Dh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAcceptConnectPort PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 024B11F7Eh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtMapUserPhysicalPagesScatter PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 01B920D17h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtWaitForSingleObject PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 088A6BA18h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCallbackReturn PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00C860F16h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtReadFile PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0D17ACFDFh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtDeviceIoControlFile PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0D058081Eh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtWriteFile PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 006500EC6h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtRemoveIoCompletion PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 082ABE027h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtReleaseSemaphore PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0BE24E888h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtReplyWaitReceivePort PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 024B1233Ah        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtReplyPort PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 020B13F1Ah        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetInformationThread PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 01430DA9Ah        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetEvent PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 056CC5758h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtClose PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0C092DF29h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryObject PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00A157A99h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryInformationFile PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0921B402Ch        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenKey PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 03AA6DB3Ch        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtEnumerateValueKey PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0C302F6BCh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtFindAtom PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 037A0B5B1h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryDefaultLocale PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 01BA51903h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryKey PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 09B8AB830h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryValueKey PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00E5B29C4h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAllocateVirtualMemory PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 08790CD43h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryInformationProcess PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0922889A5h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtWaitForMultipleObjects32 PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0626CE3A3h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtWriteFileGather PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 01B81F39Bh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateKey PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0D2A2C738h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtFreeVirtualMemory PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 059CC232Fh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtImpersonateClientOfPort PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0BC34DDA6h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtReleaseMutant PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 03CA23B38h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryInformationToken PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0DF9BFD48h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtRequestWaitReplyPort PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 02FB0042Fh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenThreadToken PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0338C4B66h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryInformationThread PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0B00FFAA1h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenProcess PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00D94081Ch        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetInformationFile PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00C5F8478h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtMapViewOfSection PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 058F1C4F3h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAccessCheckAndAuditAlarm PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 052D3324Eh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtUnmapViewOfSection PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0A300E7D2h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtReplyWaitReceivePortEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0058A6375h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtTerminateProcess PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 04D9E6C0Ah        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetEventBoostPriority PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 054CF4A58h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtReadFileScatter PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0519A1B5Fh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenThreadTokenEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 07AEDB857h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenProcessTokenEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0D2DF9064h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryPerformanceCounter PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0DF93EB29h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtEnumerateKey PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 011DA8ECCh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenFile PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 019981138h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtDelayExecution PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0F6950C01h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryDirectoryFile PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0BA198A8Eh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQuerySystemInformation PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 074287CB3h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenSection PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0029823CBh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryTimer PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 02D1613A6h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtFsControlFile PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 06CD43660h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtWriteVirtualMemory PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 043954907h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCloseObjectAuditAlarm PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0C638D6B6h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtDuplicateObject PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 01BB7E4F4h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryAttributesFile PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 03CE93872h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtClearEvent PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 030AD2F3Eh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenEvent PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00812CE49h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAdjustPrivilegesToken PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 039970D0Ah        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtDuplicateToken PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0D068C0EAh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtContinue PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0069F5150h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryDefaultUILanguage PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0C493874Bh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueueApcThread PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0F0533EF1h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtYieldExecution PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0168A301Fh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAddAtom PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0DCC8D95Ah        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateEvent PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0C8CBDB6Ch        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryVolumeInformationFile PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 03D3D51B9h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateSection PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0369E1803h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtFlushBuffersFile PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0ED542773h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtApphelpCacheControl PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 063B28CE1h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateProcessEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0418F4136h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateThread PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0D04A0DF3h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtIsProcessInJob PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 02BD3D983h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtProtectVirtualMemory PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 033AD18FFh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQuerySection PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0F2ADD07Eh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtResumeThread PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0604FEA59h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtTerminateThread PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 01A3BD489h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtReadRequestData PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 02CC5D6DCh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateFile PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 060BAE0A0h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryEvent PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 072A46328h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtWriteRequestData PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 09E3F9494h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenDirectoryObject PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 09CB8C47Ch        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAccessCheckByTypeAndAuditAlarm PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0D1B5D522h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtWaitForMultipleObjects PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0F3BF6DD3h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetInformationObject PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00A140889h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCancelIoFile PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 01EBB145Ah        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtTraceEvent PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 032AC1B08h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtPowerInformation PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0D24BF41Fh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetValueKey PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 019CCF3AEh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCancelTimer PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00BE77D04h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetTimer PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 003CA714Ah        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAccessCheckByType PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 03E6602C0h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAccessCheckByTypeResultList PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0F770FDEEh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAccessCheckByTypeResultListAndAuditAlarm PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 03AB5DA3Ah        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAccessCheckByTypeResultListAndAuditAlarmByHandle PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0FFB3936Bh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAcquireProcessActivityReference PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 038EABBD6h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAddAtomEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0859241CEh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAddBootEntry PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0178B6306h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAddDriverEntry PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 085609BE6h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAdjustGroupsToken PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0ED48C794h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAdjustTokenClaimsAndDeviceGroups PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0339116C1h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAlertResumeThread PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 077503FFBh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAlertThread PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 06CC7B679h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAlertThreadByThreadId PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0CB2CBFFCh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAllocateLocallyUniqueId PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 039D9514Ch        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAllocateReserveObject PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 02F14185Fh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAllocateUserPhysicalPages PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 082A2AB1Eh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAllocateUuids PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 02B891935h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAllocateVirtualMemoryEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 048DC9A76h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAlpcAcceptConnectPort PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0E0B4EB2Ah        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAlpcCancelMessage PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 07E5223F3h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAlpcConnectPort PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 038CE0540h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAlpcConnectPortEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0A58FE94Bh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAlpcCreatePort PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 018B0193Ch        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAlpcCreatePortSection PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0D68B8CAFh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAlpcCreateResourceReserve PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 050A3420Bh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAlpcCreateSectionView PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 02EB91D03h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAlpcCreateSecurityContext PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0762C79ACh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAlpcDeletePortSection PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0268C221Fh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAlpcDeleteResourceReserve PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 004873A1Fh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAlpcDeleteSectionView PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 08932ECACh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAlpcDeleteSecurityContext PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 030960B26h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAlpcDisconnectPort PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 065B5005Bh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAlpcImpersonateClientContainerOfPort PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0B032BAACh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAlpcImpersonateClientOfPort PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0184D1FDEh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAlpcOpenSenderProcess PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 09E2F87A3h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAlpcOpenSenderThread PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 098B89216h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAlpcQueryInformation PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 05B3453AFh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAlpcQueryInformationMessage PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00695030Ch        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAlpcRevokeSecurityContext PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0DF02DAF3h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAlpcSendWaitReceivePort PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0A1B0DE3Bh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAlpcSetInformation PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 06A72149Fh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAreMappedFilesTheSame PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 015CE86FAh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAssignProcessToJobObject PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0E8B068AFh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAssociateWaitCompletionPacket PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0BB0DDDF6h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCallEnclave PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00CB0607Ah        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCancelIoFileEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 03AE04E1Dh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCancelSynchronousIoFile PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0DA4CC0CCh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCancelTimer2 PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00FECA885h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCancelWaitCompletionPacket PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00B3F71D0h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCommitComplete PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0B823FA8Ch        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCommitEnlistment PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 009690CFFh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCommitRegistryTransaction PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 004AF467Fh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCommitTransaction PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0C863DAC7h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCompactKeys PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 04DB14E22h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCompareObjects PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 099D3748Ah        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCompareSigningLevels PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00D2345E6h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCompareTokens PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 09D34F7A1h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCompleteConnectPort PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 060BE692Ch        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCompressKey PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 09FDCBC45h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtConnectPort PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0984F83E0h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtConvertBetweenAuxiliaryCounterAndPerformanceCounter PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 07BAA1331h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateDebugObject PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 05D465BDBh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateDirectoryObject PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 03A98723Bh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateDirectoryObjectEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0C6AD15F7h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateEnclave PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 09D34A76Bh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateEnlistment PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 02EA9293Ah        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateEventPair PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0E6D6E644h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateIRTimer PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 001978E8Ah        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateIoCompletion PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0A60DC6DBh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateJobObject PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 01C44E82Fh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateJobSet PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0F3ADA963h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateKeyTransacted PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0105C9343h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateKeyedEvent PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 040C37976h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateLowBoxToken PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0102E7CDBh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateMailslotFile PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0C51A344Dh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateMutant PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0B83B959Ah        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateNamedPipeFile PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 078E2B944h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreatePagingFile PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0891B4D47h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreatePartition PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 072EC523Fh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreatePort PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0EF7CF4F3h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreatePrivateNamespace PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 01EA15714h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateProcess PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 005A6042Ah        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateProfile PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 01294C322h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateProfileEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 059B78DEBh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateRegistryTransaction PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0408A2793h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateResourceManager PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0352345E6h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateSemaphore PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 07EABA212h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateSymbolicLinkObject PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0FE55697Eh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateThreadEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 067B92B6Ch        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateTimer PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0D596F72Ah        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateTimer2 PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0FF4353DDh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateToken PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0D5E0E364h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateTokenEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0D687D038h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateTransaction PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 000AA0039h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateTransactionManager PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0B6299A8Bh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateUserProcess PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 003DE3052h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateWaitCompletionPacket PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 089B5A1E9h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateWaitablePort PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0DE70DBE8h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateWnfStateName PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0724CE547h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateWorkerFactory PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 09F08E7FBh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtDebugActiveProcess PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 05DD75244h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtDebugContinue PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0C2AA10E5h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtDeleteAtom PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0BD539CC5h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtDeleteBootEntry PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 059C45356h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtDeleteDriverEntry PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 009D4792Ch        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtDeleteFile PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0B884A027h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtDeleteKey PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 036AF1504h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtDeleteObjectAuditAlarm PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 098171408h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtDeletePrivateNamespace PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 03D9D2224h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtDeleteValueKey PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0195DE73Bh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtDeleteWnfStateData PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0D2C1B8CCh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtDeleteWnfStateName PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0B4B3CDA7h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtDisableLastKnownGood PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0984EF6C7h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtDisplayString PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 056820DA2h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtDrawText PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0D188DE1Ah        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtEnableLastKnownGood PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 05DCDCEFAh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtEnumerateBootEntries PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0100D6BE4h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtEnumerateDriverEntries PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 01C4C15D3h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtEnumerateSystemEnvironmentValuesEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0ABA2D345h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtEnumerateTransactionObject PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 09AA6B838h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtExtendSection PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00F17E255h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtFilterBootOption PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0801FE6CBh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtFilterToken PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 01141E625h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtFilterTokenEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 07F64C143h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtFlushBuffersFileEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0C82794F3h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtFlushInstallUILanguage PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 03497B8BEh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtFlushInstructionCache PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 09BBC529Fh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtFlushKey PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0AC9EC70Eh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtFlushProcessWriteBuffers PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0F0ADFA34h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtFlushVirtualMemory PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00B19E77Dh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtFlushWriteBuffer PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 095A8E36Dh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtFreeUserPhysicalPages PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 08EB3BF31h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtFreezeRegistry PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0D65CDED3h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtFreezeTransactions PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00F95273Fh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtGetCachedSigningLevel PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0A0F39470h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtGetCompleteWnfStateSubscription PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00B2449F7h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtGetContextThread PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0E4CFEA65h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtGetCurrentProcessorNumber PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0120B149Eh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtGetCurrentProcessorNumberEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 08A95CA4Eh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtGetDevicePowerState PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 032ABE396h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtGetMUIRegistryInfo PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0B4BF7BE2h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtGetNextProcess PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00EA40939h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtGetNextThread PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 017B0C803h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtGetNlsSectionPtr PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 036701BEEh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtGetNotificationResourceManager PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 003D36B32h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtGetWriteWatch PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 038953236h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtImpersonateAnonymousToken PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 023817B2Ch        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtImpersonateThread PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 02E857245h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtInitializeEnclave PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 002A4122Eh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtInitializeNlsFiles PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0E0AA2EF8h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtInitializeRegistry PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0DF4EF5DCh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtInitiatePowerAction PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 04ED029C5h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtIsSystemResumeAutomatic PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 01A5A3BC1h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtIsUILanguageComitted PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0C44BF694h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtListenPort PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 03AB62139h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtLoadDriver PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0329F0E32h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtLoadEnclaveData PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 08238B0B4h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtLoadHotPatch PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0128EDCA8h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtLoadKey PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0DE1FCB83h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtLoadKey2 PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 05DC1A26Ch        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtLoadKeyEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 01B9CD6C9h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtLockFile PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 058C62A5Eh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtLockProductActivationKeys PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0A731BC9Eh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtLockRegistryKey PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0EFDD3381h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtLockVirtualMemory PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 041DB5735h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtMakePermanentObject PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 038140EAEh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtMakeTemporaryObject PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 09BB9ADFBh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtManagePartition PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00C942A01h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtMapCMFModule PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0814EBD0Fh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtMapUserPhysicalPages PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 01F46EE38h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtMapViewOfSectionEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 09802BAB8h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtModifyBootEntry PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0319C2B0Eh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtModifyDriverEntry PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 059B42742h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtNotifyChangeDirectoryFile PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 01D4B0FF2h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtNotifyChangeDirectoryFileEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00AB9406Bh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtNotifyChangeKey PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0C1151F43h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtNotifyChangeMultipleKeys PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0A73EA0B4h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtNotifyChangeSession PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0DE40BE8Dh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenEnlistment PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00FE20879h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenEventPair PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0B132DD2Ch        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenIoCompletion PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0130973C4h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenJobObject PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0209C1A11h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenKeyEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0599B9D27h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenKeyTransacted PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0945AACC6h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenKeyTransactedEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 08C9CCEA6h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenKeyedEvent PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0BF328485h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenMutant PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0920C755Eh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenObjectAuditAlarm PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0E5BB29E2h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenPartition PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0CA510903h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenPrivateNamespace PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0BB143C29h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenProcessToken PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0F3A2997Ah        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenRegistryTransaction PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 01E3472E7h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenResourceManager PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0AE35E0EDh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenSemaphore PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 078D65A0Eh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenSession PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 09F347F66h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenSymbolicLinkObject PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 006DA0C47h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenThread PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0130D5DA6h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenTimer PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 038980035h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenTransaction PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 07F535309h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenTransactionManager PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 031361FA6h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtPlugPlayControl PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0CC9B8C4Fh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtPrePrepareComplete PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 088D27090h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtPrePrepareEnlistment PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00190FEDBh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtPrepareComplete PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 070E1768Ah        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtPrepareEnlistment PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 049C74C4Dh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtPrivilegeCheck PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0411A56A1h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtPrivilegeObjectAuditAlarm PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0F8571D07h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtPrivilegedServiceAuditAlarm PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00A0A6EDCh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtPropagationComplete PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0C695C5FBh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtPropagationFailed PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00952F80Eh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtPulseEvent PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 060C3055Ah        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryAuxiliaryCounterFrequency PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 06B67B631h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryBootEntryOrder PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0A53B8589h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryBootOptions PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 05B9795D7h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryDebugFilterState PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0228C7242h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryDirectoryFileEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 02C966221h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryDirectoryObject PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0369A2C17h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryDriverEntryOrder PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0F74BD1DFh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryEaFile PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 076DFBB8Eh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryFullAttributesFile PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 022B02E26h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryInformationAtom PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0B23C4D34h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryInformationByName PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 07C304DEAh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryInformationEnlistment PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 01E5901CAh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryInformationJobObject PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00B36E544h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryInformationPort PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0AE30ABA2h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryInformationResourceManager PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 096B1A617h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryInformationTransactionManager PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0B22EBEB3h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryInformationWorkerFactory PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0DA6EEAD0h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryInstallUILanguage PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 09D3BD880h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryIntervalProfile PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0B62190B8h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryIoCompletion PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 09C319EA5h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryLicenseValue PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 02C9C3D36h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryMultipleValueKey PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 042FEB184h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryMutant PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 07E9E7F0Ah        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryOpenSubKeys PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0A6B1CF65h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryOpenSubKeysEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 069D5B4B1h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryPortInformationProcess PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 003BF1E32h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryQuotaInformationFile PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 091376927h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQuerySecurityAttributesToken PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0DB0DCF84h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQuerySecurityObject PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 03A99527Dh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQuerySecurityPolicy PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 008A12D1Dh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQuerySemaphore PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 034DCD754h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQuerySymbolicLinkObject PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0E855D0F9h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQuerySystemEnvironmentValue PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0C242310Ah        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQuerySystemEnvironmentValueEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0534877F5h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQuerySystemInformationEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0189BDB20h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryTimerResolution PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 03FA5C22Eh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryWnfStateData PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 042D4AFDAh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueryWnfStateNameInformation PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 04B476FD5h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueueApcThreadEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 030A21419h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtRaiseException PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 01A8E1E1Fh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtRaiseHardError PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 08596E57Bh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtReadOnlyEnlistment PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 021BB3A3Ch        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtRecoverEnlistment PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 041A14427h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtRecoverResourceManager PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 08833D019h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtRecoverTransactionManager PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00991697Ch        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtRegisterProtocolAddressInformation PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 019831910h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtRegisterThreadTerminatePort PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0DD7EE8D7h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtReleaseKeyedEvent PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 050DBB946h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtReleaseWorkerFactoryWorker PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0409F9233h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtRemoveIoCompletionEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 06E8DAC37h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtRemoveProcessDebug PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00B9C4FB3h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtRenameKey PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 02701148Ch        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtRenameTransactionManager PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00DBF9196h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtReplaceKey PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 045026CA2h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtReplacePartitionUnit PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 02832AA24h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtReplyWaitReplyPort PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 02CE8A3FAh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtRequestPort PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 01EB3273Eh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtResetEvent PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 08A91A334h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtResetWriteWatch PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 02290E8B2h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtRestoreKey PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 01AAF6153h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtResumeProcess PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0E12FDAA0h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtRevertContainerImpersonation PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0944D96DDh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtRollbackComplete PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0F4BE08E4h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtRollbackEnlistment PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00986CEDDh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtRollbackRegistryTransaction PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 06A92543Fh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtRollbackTransaction PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 03AAE55B7h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtRollforwardTransactionManager PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0079F6904h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSaveKey PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0FF24E4A6h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSaveKeyEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 01982E6F5h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSaveMergedKeys PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 067FC626Ah        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSecureConnectPort PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 06EF55F38h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSerializeBoot PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 09DC09746h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetBootEntryOrder PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0D34BD7D1h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetBootOptions PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0998953C9h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetCachedSigningLevel PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 09ED7B08Dh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetCachedSigningLevel2 PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 013493A99h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetContextThread PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 06840216Dh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetDebugFilterState PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0E29DE272h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetDefaultHardErrorPort PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 028AC5922h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetDefaultLocale PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0039A7D8Fh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetDefaultUILanguage PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 01FB9561Ah        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetDriverEntryOrder PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 01FA03EF3h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetEaFile PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0D842DBE6h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetHighEventPair PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 03491939Fh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetHighWaitLowEventPair PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0835383CAh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetIRTimer PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0B78B652Bh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetInformationDebugObject PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 002B6303Bh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetInformationEnlistment PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0E8B8F12Eh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetInformationJobObject PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 03F204BEFh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetInformationKey PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0F3A0CE14h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetInformationResourceManager PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 03DBE1762h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetInformationSymbolicLink PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0E27FE4E2h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetInformationToken PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 07B4F3072h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetInformationTransaction PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0C950E5C2h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetInformationTransactionManager PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 015928792h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetInformationVirtualMemory PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 035D5335Bh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetInformationWorkerFactory PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00492405Ch        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetIntervalProfile PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 084DBAC48h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetIoCompletion PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0251313B0h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetIoCompletionEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 086A3E25Eh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetLdtEntries PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0250F5CE3h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetLowEventPair PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0991DBF8Ah        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetLowWaitHighEventPair PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0F0D608A3h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetQuotaInformationFile PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 040DA3040h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetSecurityObject PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00EA53629h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetSystemEnvironmentValue PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 02EB952BEh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetSystemEnvironmentValueEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0F4073D79h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetSystemInformation PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 018B21A27h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetSystemPowerState PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00E106918h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetSystemTime PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0EE8ECF0Ah        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetThreadExecutionState PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0BD35771Bh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetTimer2 PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 049C9E91Fh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetTimerEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 08287B03Dh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetTimerResolution PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0CA9C35D0h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetUuidSeed PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 049D26956h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetWnfProcessNotificationEvent PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 028092194h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtShutdownSystem PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 08C955AADh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtShutdownWorkerFactory PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0B31EBB91h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSignalAndWaitForSingleObject PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 01E3464DAh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSinglePhaseReject PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0091367E9h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtStartProfile PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0811B4041h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtStopProfile PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 001BA9781h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSubscribeWnfStateChange PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 066C76366h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSuspendProcess PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0F12FE2A0h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSuspendThread PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0200B3EB1h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSystemDebugControl PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0DD8322C1h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtTerminateEnclave PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0FCDBEA57h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtTerminateJobObject PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0BC80DA1Ah        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtTestAlert PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0F395EE04h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtThawRegistry PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 01C911A1Dh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtThawTransactions PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 011DA7109h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtTraceControl PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 043944F73h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtTranslateFilePath PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0F2D1BF04h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtUmsThreadYield PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 075B9640Dh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtUnloadDriver PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 01C964044h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtUnloadKey PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 07FC55061h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtUnloadKey2 PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 01EBAC755h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtUnloadKeyEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 04B5B971Ch        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtUnlockFile PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0094B238Dh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtUnlockVirtualMemory PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0BC6AC0ACh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtUnmapViewOfSectionEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 044D27E67h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtUnsubscribeWnfStateChange PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00859FA41h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtUpdateWnfStateData PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 08C43B0E0h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtVdmControl PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0379A0CCDh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtWaitForAlertByThreadId PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0584708B2h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtWaitForDebugEvent PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 01894251Ch        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtWaitForKeyedEvent PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0F192D1C6h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtWaitForWorkViaWorkerFactory PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0CB5DC9CBh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtWaitHighEventPair PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 012BE362Bh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtWaitLowEventPair PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 02395B9B2h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAcquireCMFViewOwnership PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 06DB4F7BDh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCancelDeviceWakeupRequest PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0178ED9D4h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtClearAllSavepointsTransaction PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0080F089Dh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtClearSavepointTransaction PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 000DA278Bh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtRollbackSavepointTransaction PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 09912C5BCh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSavepointTransaction PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00224EE3Fh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSavepointComplete PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 034BB5230h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateSectionEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0AE9CEC26h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateCrossVmEvent PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0D66CD1FFh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtGetPlugPlayEvent PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0D801365Ch        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtListTransactions PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 047973B75h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtMarshallTransaction PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0B06FF4C5h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtReleaseCMFViewOwnership PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0134D2BC5h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtWaitForWnfNotifications PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00399370Fh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtStartTm PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0BD90DD6Ch        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtSetInformationProcess PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0812B82A4h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtRequestDeviceWakeup PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 001E20D7Eh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtRequestWakeupLatency PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 090A979D4h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQuerySystemTime PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 04017854Fh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtManageHotPatch PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 060DA584Ah        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtContinueEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 057CE8392h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
